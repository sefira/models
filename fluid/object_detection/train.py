...
def parallel_exe(args,
    ...
    gt_box.persistable=True
    gt_label.persistable=True
    difficult.persistable=True
    ...
    for pass_id in range(num_passes):
        ...
        for batch_id, data in enumerate(train_reader()):
            ...
            if has_nan:
                print("nan when batch {}".format(batch_id))
                print("debug_model has been saved in debug_batch_{}".format(str(batch_id % 2)))
                print("last debug_model has been saved in debug_batch_{}".format(str((batch_id - 1) % 2)))
                print(np.isnan(batch_norm_34))
                sys.exit(1)
